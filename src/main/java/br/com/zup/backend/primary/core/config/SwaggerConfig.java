package br.com.zup.backend.primary.core.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.zup.backend.primary.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Demo Test for zup company",
                "This API is utilizated for demonstration test for zup company",
                "Versão 1.0",
                "",
                new Contact("Guilherme Lourenco", "https://github.com/Gu1lh3rm/zup-test", "guilhermemonteirolourenco@gmail.com"),
                "Permited for zup company",
                "",
