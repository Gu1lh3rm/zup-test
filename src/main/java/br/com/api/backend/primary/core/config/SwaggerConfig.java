package br.com.api.backend.primary.core.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.api.backend"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Demo Test for api company",
                "This API is utilizated for demonstration test for api company",
                "Versão 1.0",
                "",
                new Contact("Guilherme Lourenco", "https://github.com/Gu1lh3rm/api-test", "guilhermemonteirolourenco@gmail.com"),
