package br.com.api.backend.primary.services.validation.utils;
...
public class BR {
     ...
     * @return
     */
    public static boolean isValidCPF(final Long ssnL) {
        String ssn = ssnL.toString();
     ...
     * @return
     */
    public static boolean isValidCNPJ(final Long tinL) {
        String tin = tinL.toString();
